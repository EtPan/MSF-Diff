...
class UnmixingAE(nn.Module):
    def __init__(self, n_blocks, res_scale, input_channels=3, output_channels =59, conv= default_conv):
        ...
        self.decoderlayer = nn.Conv2d(in_channels=5,out_channels=self.output_channels,kernel_size=(1,1),bias=False)
