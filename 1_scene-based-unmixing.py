...
def train_unmixing(args):
    ...
    net = UnmixingAE(n_blocks=args.n_blocks, res_scale = 0.1, input_channels=3, output_channels = colors, conv=default_conv)
...
def infer_abu(args):
    ...
    net = UnmixingAE(n_blocks=args.n_blocks, res_scale = 0.1, input_channels=3, output_channels = 59, conv=default_conv)
